...
app.patch("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id);
  let patchedJokeIndex = jokes.find((joke) => joke.id === id);
  let updatedJoke = {
    id,
    jokeText: req.body.text || patchedJokeIndex.jokeText,
    jokeType: req.body.type || patchedJokeIndex.jokeType,
  };

  jokes[patchedJokeIndex] = updatedJoke;
  res.json(updatedJoke);
});
